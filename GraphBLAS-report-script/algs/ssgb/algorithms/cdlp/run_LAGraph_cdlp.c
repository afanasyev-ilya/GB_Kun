...
int main(int argc, char **argv) {
  ...
  int res = LAGraph_cdlp(&CDLP_handle, A, false, false, 1000, tt, msg);
  ...
  LAGraph_Tic(tic, NULL);
  f = fopen("ans.mtx", "w");
  LAGraph_Vector_Print(CDLP_handle, LAGraph_COMPLETE_VERBOSE, f, msg);
  fclose(f);
