...
template <typename T>
void SpMV_load_balanced(const MatrixVectGroupCSR<T> *_matrix,
...
template <typename T>
void SpMV_vector(const MatrixVectGroupCSR<T> *_matrix,
                 const DenseVector<T> *_x,
                 DenseVector<T> *_y)
{
    const T *x_vals = _x->get_vals();
...
template <typename T>
void SpMV(const MatrixVectGroupCSR<T> *_matrix,
          const DenseVector<T> *_x,
          DenseVector<T> *_y)
{
